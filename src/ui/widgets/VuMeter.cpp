...
VuMeter_t* vu_meter_create(lv_obj_t* parent, int32_t x, int32_t y, 
    ...
    lv_obj_set_style_bg_color(meter->container, UiTheme_get_color(COLOR_BG_SECONDARY), 0);
    ...
    lv_obj_set_style_bg_grad_dir(meter->bar, LV_GRAD_DIR_VER, LV_PART_INDICATOR);
    ...
    lv_obj_set_style_bg_color(meter->peak_indicator, LV_COLOR_MAKE(0xFF, 0x00, 0x00), 0);
    ...
    lv_obj_set_style_text_color(meter->db_label, UiTheme_get_color(COLOR_TEXT_SECONDARY), 0);
